...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'info@sstgroupholding.co.za');
define('EMAIL_TO_NAME', 'SST Group Holding');

define('EMAIL_TO_CC', 'mabasolindanircardo@gmail.com');
define('EMAIL_TO_CC_NAME', 'Lindani');

define('EMAIL_TO_BCC', 'odaniso@sstgroupholding.co.za');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'info@sstgroupholding.co.za');
...
define('EMAIL_SUBJECT', "New Website Email");
